      ...
      <div className="container mx-auto pt-4 pt-20 py-4 px-4 max-w-full">
        ...
        <div className="lg:max-w-5xl mx-auto text-white">
          ...
          <div className="mt-8 mb-20 lg:max-w4xl mx-auto">
            ...
            <p className="text-white text-xl lg:text-3xl font-cursive">I help frustrated cloud-native technology teams <span className="bg-secondary text-primary">deploy well-architected iintegration systems that deliver confidence</span> in security, uptime, performance & results. Build integrations with <span className="text-secondary">99.99%</span> uptime, <span className="text-secondary">1 million</span> transactions / second & real-time notifications that provides satisfaction for all business users, customers & stakeholders. </p>
          </div>
